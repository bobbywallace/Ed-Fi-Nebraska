CREATE TABLE [edfi].[StudentObjectiveAssessment] (
    ...
    CONSTRAINT [PK_StudentObjectiveAssessment] PRIMARY KEY CLUSTERED ([StudentUSI] ASC, [ObjectiveItem] ASC, [AssessmentTitle] ASC, [AcademicSubjectTypeId] ASC, [AssessedGradeLevelTypeId] ASC, [Version] ASC, [AdministrationDate] ASC) WITH (DATA_COMPRESSION = PAGE)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Student Identity Column', @level0type = N'SCHEMA', @level0name = N'edfi', @level1type = N'TABLE', @level1name = N'StudentObjectiveAssessment', @level2type = N'COLUMN', @level2name = N'StudentUSI';
